...
public:
  ...
  std::pair<Key, uint8_t> getKey(const std::string_view utf8_string) {
    for (auto c : utf8_to_wide(utf8_string))
...
int WINAPI wWinMain(HINSTANCE instance, HINSTANCE, LPWSTR, int) {
  ...
  //auto layout = LoadKeyboardLayoutW(name, KLF_ACTIVATE);
  //const auto result = VkKeyScanExW(L'â', layout);
  //const auto vk = (result & 0xFF);
  //const auto modifier = (result >> 8);
  //const auto shift = ((modifier & 0x01) != 0);
  //const auto ctrl = ((modifier & 0x02) != 0);
  //const auto alt = ((modifier & 0x04) != 0);
  //const auto a = 'q';
  //const auto b = 'Q';
  //auto s = StringTyper();
  //auto k = s.getKey("?");
